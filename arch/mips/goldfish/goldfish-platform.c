...
void __init plat_mem_setup(void)
{
	...
	defined(CONFIG_MIPS_DTB_ALTERNATIVE_POSITION)
	pr_info("Try setup using Appended DTB\n");
	pr_info("DTB address: %p\n", (void *)fw_passed_dtb);
	/*
	...
	if (highmem_ramsize)
		add_memory_region(HIGHMEM_OFFSET, highmem_ramsize,
					BOOT_MEM_RAM);
...
static const struct of_device_id goldfish_ids[] __initconst = {
